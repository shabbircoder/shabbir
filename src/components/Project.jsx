...
//       <div className="flex justify-center pb-4 bg-[#3d3d3d] text-xl text-white space-x-4">
//         <button
//           onClick={() => handleTabChange("All")}
//           className={`border rounded px-4 py-2 ${
//             selectedTab === "All" ? "bg-white text-black" : ""
//           }`}
//         >
//           All
//         </button>
...
//           className={`border rounded px-4 py-2 ${
//             selectedTab === "Major" ? "bg-white text-black" : ""
//           }`}
//         >
//           Major-App
//         </button>
...
//           className={`border rounded px-4 py-2 ${
//             selectedTab === "HTML" ? "bg-white text-black" : ""
//           }`}
//         >
//           HTML
//         </button>
...
//           className={`border rounded px-4 py-2 ${
//             selectedTab === "REACT" ? "bg-white text-black" : ""
//           }`}
//         >
//           React
//         </button>
